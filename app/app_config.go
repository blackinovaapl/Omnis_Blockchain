...
import (
	_ "omnis/x/omnis/module"
	omnismoduletypes "omnis/x/omnis/types"
	_ "omnis/x/token/module"
	tokenmoduletypes "omnis/x/token/types"
	"time"
...
var (
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			{
				Name:   omnismoduletypes.ModuleName,
				Config: appconfig.WrapAny(&omnismoduletypes.Module{}),
			},
			{
